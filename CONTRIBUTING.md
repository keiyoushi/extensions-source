...
Always use camelCase for Kotlin properties and map them to snake_case JSON keys using `@SerialName`.
...
// Good: Regular class, camelCase variables mapped with @SerialName
@Serializable
class MyDto(
