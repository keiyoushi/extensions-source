...
abstract class MangaBox(
    ...
    open fun getGenreFilters(): Array<Pair<String?, String>> = arrayOf(
        ...
        Pair("anotherchance", "Another chance"),
        ...
        Pair("comedy", "Comedy"),
        Pair("comedyreturner", "Comedyreturner"),
        Pair("comic", "Comic"),
        ...
        Pair("genius-mc", "Genius mc"),
        Pair("ghosts", "Ghosts"),
        Pair("girls-love", "Girls love"),
        Pair("gisaeng", "Gisaeng"),
        Pair("gore", "Gore"),
        Pair("gore-guns", "Gore guns"),
        ...
        Pair("korean", "Korean"),
        Pair("ladies", "Ladies"),
        Pair("lice-of-life", "Lice of life"),
        ...
        Pair("manga", "Manga"),
        Pair("manga-adaptation", "Manga adaptation"),
        ...
        Pair("medical-system", "Medical system"),
        Pair("medicaldrama", "Medicaldrama"),
        Pair("mercenary", "Mercenary"),
        ...
        Pair("slaves", "Slaves"),
        Pair("slice", "Slice"),
        Pair("slice-of-lif", "Slice of lif"),
        ...
        Pair("superpowers-system", "Superpowers system"),
        Pair("survival", "Survival"),
        Pair("suspense", "Suspense"),
        Pair("swords", "Swords"),
        Pair("system", "System"),
        Pair("systems", "Systems"),
        Pair("tamer", "Tamer"),
        ...
        Pair("virtual", "Virtual"),
        Pair("virtual-reality", "Virtual reality"),
        Pair("voilence", "Voilence"),
