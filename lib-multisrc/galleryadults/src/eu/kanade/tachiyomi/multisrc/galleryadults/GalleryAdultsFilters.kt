...
class SortOrderFilter(
    sortOrderURIs: List<Pair<String, String>>,
...
class CategoryFilters(
    flags: List<SearchFlagFilter>,
) : Filter.Group<SearchFlagFilter>("Categories", flags)

// Advance search
abstract class AdvancedTextFilter(
    name: String,
) : Filter.Text(name)
