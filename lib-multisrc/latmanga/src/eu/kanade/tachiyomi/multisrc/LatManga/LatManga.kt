...
abstract class LatManga(
    override val name: String,
    override val baseUrl: String,
    override val lang: String,
    protected val organizationDomain: String = baseUrl.substringAfter("://"),
    protected val apiBaseUrl: String = "https://lat-manga.com",
) : HttpSource() {
    ...
    override fun getFilterList() = FilterList(
        SortByFilter(intl["sort_by_filter_title"], getSortList()),
    )

    private fun getSortList() = arrayOf(
        Pair(intl["sort_by_popular"], "popular"),
        Pair(intl["sort_by_latest"], "latest"),
    )
    ...
    override fun chapterListParse(response: Response): List<SChapter> {
        ...
        return result.data.chapters?.map { it.toSChapter(intl["chapter_prefix"], seriesSlug) } ?: emptyList()
    }
