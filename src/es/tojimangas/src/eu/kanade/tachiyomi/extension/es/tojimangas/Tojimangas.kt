...
class Tojimangas : ParsedHttpSource() {
    ...
    private fun parseRelativeDate(date: String): Long {
        ...
        return when {
            WordSet("segundo", "segundos").anyWordIn(date) ->
                cal
                    .apply {
                        add(
                            Calendar.SECOND,
            ...
            WordSet("minuto", "minutos").anyWordIn(date) ->
                cal
                    .apply {
                        add(
                            Calendar.MINUTE,
            ...
            WordSet("día", "días").anyWordIn(date) ->
                cal
                    .apply {
                        add(
            ...
            WordSet("hora", "horas").anyWordIn(date) ->
                cal
                    .apply {
                        add(
                            Calendar.HOUR,
            ...
            WordSet("semana", "semanas").anyWordIn(date) ->
                cal
                    .apply {
                        add(
                            Calendar.DAY_OF_MONTH,
            ...
            WordSet("mes", "meses").anyWordIn(date) ->
                cal
                    .apply {
                        add(
                            Calendar.MONTH,
            ...
            WordSet("año", "años").anyWordIn(date) ->
                cal
                    .apply {
                        add(
                            Calendar.YEAR,
