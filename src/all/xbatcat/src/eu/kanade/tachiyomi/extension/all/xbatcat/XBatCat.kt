...
import eu.kanade.tachiyomi.extension.all.xbatcatv4.XBatCatV4
...
open class XBatCat(
    ...
    private val _delegate: HttpSource =
        if (baseUrl in mirrorsV4) {
            XBatCatV4(baseUrl, lang, siteLang, preferences)
        } else {
            throw UnsupportedOperationException("Unsupported mirror version")
        }
