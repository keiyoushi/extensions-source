...
abstract class EHentai(
    ...
    companion object {
        ...
        private const val EXHENTAI_PREF_KEY = "EXHENTAI"
        private const val EXHENTAI_PREF_TITLE = "Activate Exhentai"
        private const val EXHENTAI_PREF_SUMMARY = "You need to login via WebView before checking this, after checked restart the app"
        private const val EXHENTAI_PREF_DEFAULT_VALUE = false
    ...
    override fun setupPreferenceScreen(screen: PreferenceScreen) {
        ...
        val exhentaiPref = CheckBoxPreference(screen.context).apply {
            key = "${EXHENTAI_PREF_KEY}_$lang"
            title = EXHENTAI_PREF_TITLE
            summary = EXHENTAI_PREF_SUMMARY
            setDefaultValue(EXHENTAI_PREF_DEFAULT_VALUE)

            setOnPreferenceChangeListener { _, newValue ->
                val checkValue = newValue as Boolean
                preferences.edit().putBoolean("${EXHENTAI_PREF_KEY}_$lang", checkValue).commit()
            }
        }
        ...
        screen.addPreference(exhentaiPref)
    ...
    private fun getExhentaiPref(): Boolean = preferences.getBoolean("${EXHENTAI_PREF_KEY}_$lang", EXHENTAI_PREF_DEFAULT_VALUE)
