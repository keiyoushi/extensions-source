...
abstract class NamiComi(
    ...
    private val extLang: String = lang,
) : HttpSource(),
    ConfigurableSource {
    ...
    private fun sortedMangaRequest(
        page: Int,
        orderBy: String,
    ): Request {
        val url =
            NamiComiConstants.apiSearchUrl
                .toHttpUrl()
                .newBuilder()
    ...
    override fun searchMangaRequest(
        ...
        val finalUrl =
            helper.filters.addFiltersToUrl(
                url = tempUrl,
    ...
    override fun mangaDetailsRequest(manga: SManga): Request {
        val url =
            ("${NamiComiConstants.apiMangaUrl}/${manga.url}")
                .toHttpUrl()
                .newBuilder()
                .addCommonIncludeParameters()
                .build()
    ...
    private fun paginatedChapterListRequest(
        ...
        val url =
            NamiComiConstants.apiChapterUrl
                .toHttpUrl()
                .newBuilder()
    ...
    override fun chapterListParse(response: Response): List<SChapter> {
        ...
        for (chapterIds in chapterListResultsChunks) {
            ...
            accessibleChapterMap += gatingCheckResponse
                .parseAs<EntityAccessMapDto>()
                .data
                ?.attributes
                ?.map ?: emptyMap()
        }
