...
internal class GenreFilter(
    name: String,
    genreList: List<Pair<String, String>>,
...
internal class DemographicFilter(
    name: String,
    demographicList: List<Pair<String, String>>,
) : Filter.Group<TriFilter>(name, demographicList.map { TriFilter(it.first, it.second) })

internal class TypeFilter(
    name: String,
    typeList: List<Pair<String, String>>,
) : Filter.Group<CheckBoxFilter>(name, typeList.map { CheckBoxFilter(it.first, it.second) })

internal class CompletedFilter(
    name: String,
) : CheckBoxFilter(name)

internal class CreatedAtFilter(
    name: String,
    createdAtList: List<Pair<String, String>>,
) : SelectFilter(name, createdAtList)

internal class MinimumFilter(
    name: String,
) : TextFilter(name)

internal class FromYearFilter(
    name: String,
) : TextFilter(name)

internal class ToYearFilter(
    name: String,
) : TextFilter(name)
