...
abstract class Comick(
    ...
    private fun mangaDetailsParse(
        ...
        if (!preferences.updateCover && manga.thumbnail_url != mangaData.comic.cover) {
            ...
            val originalCovers =
                firstVol
                    .filter {
                        mangaData.comic.isoLang
                            .orEmpty()
                            .startsWith(it.locale.orEmpty())
                    }
            val localCovers =
                firstVol
    ...
    override fun getMangaUrl(manga: SManga): String = "$baseUrl${manga.url.removeSuffix("#")}"
