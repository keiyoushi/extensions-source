...
open class ContainBeginEndFilter(name: String) :
    UriPartFilter(
        name,
        arrayOf(
...
class QueryCBEFilter : ContainBeginEndFilter("Query")

class AuthorCBEFilter : ContainBeginEndFilter("Author")

class ArtistCBEFilter : ContainBeginEndFilter("Artist")
