...
object MDConstants {
    ...
    fun getCoverQualityPreferenceKey(dexLang: String): String = "${coverQualityPref}_$dexLang"
    ...
    fun getContentRatingPrefKey(dexLang: String): String = "${contentRatingPref}_$dexLang"
    ...
    fun getOriginalLanguagePrefKey(dexLang: String): String = "${originalLanguagePref}_$dexLang"
    ...
    fun getHasSanitizedUuidsPrefKey(dexLang: String): String = "${hasSanitizedUuidsPref}_$dexLang"

    private const val tryUsingFirstVolumeCoverPref = "tryUsingFirstVolumeCover"
    const val tryUsingFirstVolumeCoverDefault = false

    fun getTryUsingFirstVolumeCoverPrefKey(dexLang: String): String = "${tryUsingFirstVolumeCoverPref}_$dexLang"

    private const val altTitlesInDescPref = "altTitlesInDesc"

    fun getAltTitlesInDescPrefKey(dexLang: String): String = "${altTitlesInDescPref}_$dexLang"
