...
class MangaDexFilters {
    ...
    private class HasAvailableChaptersFilter(
        intl: Intl,
    ...
    private class OriginalLanguageList(
        intl: Intl,
    ...
    private class ContentRatingList(
        intl: Intl,
    ...
    private class TagsFilter(
        ...
        override fun addQueryParameter(
            ...
            state
                .filterIsInstance<UrlQueryFilter>()
