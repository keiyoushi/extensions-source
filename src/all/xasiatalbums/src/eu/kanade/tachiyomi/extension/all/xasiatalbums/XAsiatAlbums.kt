...
class XAsiatAlbums : ParsedHttpSource() {
    ...
    override fun latestUpdatesRequest(page: Int) =
        searchQuery("albums/", "list_albums_common_albums_list", page, mapOf(Pair("sort_by", "post_date")))
    ...
    override fun popularMangaRequest(page: Int) =
        searchQuery("albums/", "list_albums_common_albums_list", page, mapOf(Pair("sort_by", "album_viewed_week")))
        ...
        return when {
            query.isNotEmpty() ->
                searchQuery(
                    ...
                    page,
                    mutableMapOf(Pair("q", query), Pair("from_albums", page.toString())),
                )
            categoryFilter?.state != 0 ->
                searchQuery(
                    categoryFilter!!.toUriPart(),
                    "list_albums_common_albums_list",
                    page,
                    mutableMapOf(Pair("q", query)),
                )
