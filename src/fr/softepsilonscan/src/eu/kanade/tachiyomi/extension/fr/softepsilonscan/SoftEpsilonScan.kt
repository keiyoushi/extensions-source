...
class SoftEpsilonScan :
    HttpSource(),
    ConfigurableSource {
    override val name = "Soft Epsilon Scan"
    override val lang = "fr"
    override val baseUrl = "https://epsilonsoft.to"
    ...
    private fun sessionKey(serieSlug: String, chapterSlug: String) = "seps-$serieSlug--$chapterSlug"
