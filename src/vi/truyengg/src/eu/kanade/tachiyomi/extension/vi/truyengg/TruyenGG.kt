...
class TruyenGG() : ParsedHttpSource(), ConfigurableSource {
    ...
    override fun chapterFromElement(element: Element): SChapter = SChapter.create().apply {
        ...
        date_upload = parseDate(element.select("span.c199").text())
    }
    ...
    override fun latestUpdatesFromElement(element: Element): SManga = SManga.create().apply {
        setUrlWithoutDomain(element.select("a.book_name").attr("href"))
        title = element.select("a.book_name").text()
        thumbnail_url = element.select(".image-cover img").attr("data-src")
    }
    ...
    override fun mangaDetailsParse(document: Document): SManga = SManga.create().apply {
        ...
        thumbnail_url = document.select(".thumbblock img").attr("abs:src")
