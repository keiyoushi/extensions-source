...
class HentaiVN :
    ...
    // latestUpdates
    override fun latestUpdatesRequest(page: Int): Request = GET("$baseUrl/chap-moi.html?page=$page", headers)
    ...
    // Popular
    override fun popularMangaRequest(page: Int): Request = GET("$baseUrl/danh-sach.html?page=$page", headers)
    ...
    override fun fetchSearchManga(
        ...
        return when {
            ...
            query.startsWith(PREFIX_ID_SEARCH) -> {
                ...
                client
                    .newCall(searchMangaByIdRequest(ids))
                    .asObservableSuccess()
    ...
    // Pages
    override fun pageListParse(document: Document): List<Page> = document.select("#image > img").mapIndexed { i, e ->
    ...
    private fun parseDate(dateString: String): Long = kotlin
        .runCatching {
