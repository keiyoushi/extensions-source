...
companion object {  
    private const val RESTART_TACHIYOMI = "أعد تشغيل التطبيق لتطبيق الإعدادات الجديدة."  
    private const val BASE_URL_PREF_TITLE = "تعديل الرابط"  
    private const val BASE_URL_PREF = "overrideBaseUrl"  
    private const val DEFAULT_BASE_URL_PREF = "defaultBaseUrl"  
    private const val BASE_URL_PREF_SUMMARY = "للاستخدام المؤقت عند تعطل الرابط الأساسي."  
}  
