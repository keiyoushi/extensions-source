...
class ReadMangas : HttpSource() {
    ...
    override fun popularMangaRequest(page: Int): Request {
        ...
        val url =
            "$baseUrl/api/deprecated/manga.getAllManga?batch=1"
                .toHttpUrl()
                .newBuilder()
    ...
    override fun latestUpdatesRequest(page: Int): Request {
        ...
        val url =
            "$baseUrl/api/deprecated/discover.updated"
                .toHttpUrl()
                .newBuilder()
                .addQueryParameter("batch", "1")
                .addQueryParameter("input", input.toString())
        ...
        return SManga.create().apply {
            ...
            description =
                document
                    ...
                    ?.let {
                        MANGA_DETAILS_DESCRIPTION_REGEX
                            .find(it)
                            ?.groups
                            ?.get("description")
                            ?.value
    ...
    private fun chapterListRequest(
        ...
        val url =
            "$baseUrl/api/deprecated/chapter.publicAllChapters"
                .toHttpUrl()
                .newBuilder()
                .addQueryParameter("batch", "1")
                .addQueryParameter("input", input.toString())
    ...
    private fun tryFetchChapterPage(
        manga: SManga,
        page: Int,
    ): Response {
        repeat(attempts) { index ->
            try {
                return client.newCall(this.chapterListRequest(manga, page)).execute()
            } catch (e: Exception) {
                // do nothing
            }
        }
