...
class SussyToons :
    ...
    private fun fetchChapterPagesHeaders(
        ...
        fun WebResourceRequest.isOriginRequest() = originRequest.url.toString().equals(this.url.toString(), ignoreCase = true)

        chapterPageHeaders =
            handlingWithWebResourceRequest(
                baseRequest,
