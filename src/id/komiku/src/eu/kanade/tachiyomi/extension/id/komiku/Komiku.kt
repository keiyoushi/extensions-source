...
class Komiku : ParsedHttpSource() {
    ...
    private class OrderBy(
        orders: Array<Order>,
    ) : Filter.Select<Order>("Order", orders, 0)

    private class GenreList1(
        genres: Array<Genre>,
    ) : Filter.Select<Genre>("Genre 1", genres, 0)

    private class GenreList2(
        genres: Array<Genre>,
    ) : Filter.Select<Genre>("Genre 2", genres, 0)
