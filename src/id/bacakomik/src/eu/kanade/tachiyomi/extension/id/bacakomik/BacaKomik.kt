...
class BacaKomik : ParsedHttpSource() {
    ...
    override fun popularMangaRequest(page: Int): Request = GET("$baseUrl/daftar-komik/page/$page/?order=popular", headers)

    override fun latestUpdatesRequest(page: Int): Request = GET("$baseUrl/daftar-komik/page/$page/?order=update", headers)
