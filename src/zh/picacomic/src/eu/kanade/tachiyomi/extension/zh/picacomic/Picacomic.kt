...
class Picacomic :
    ...
    private fun singlePageParse(response: Response): MangasPage {
        val comics =
            json
                .decodeFromString<PicaResponse>(response.body.string())
                .data.comics!!
                .let { json.decodeFromJsonElement<List<PicaSearchComic>>(it) }
    ...
    override fun searchMangaParse(response: Response): MangasPage {
        if (response.request.url
                .toString()
                .contains("/comics/leaderboard".toRegex())
        ) {
        ...
        val comics =
            json
                .decodeFromString<PicaResponse>(
                    response.body.string(),
                ).data.comics!!
                .let { json.decodeFromJsonElement<PicaSearchComics>(it) }
