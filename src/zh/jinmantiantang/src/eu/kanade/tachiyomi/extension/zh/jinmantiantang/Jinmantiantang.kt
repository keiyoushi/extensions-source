            ...
            for (element in elements) {
                pages.apply {
                    if (element.select("div[class=center scramble-page spnotice_chk][id*=0] img").attr("src").indexOf("blank.jpg") >= 0 ||
                        element.select("div[class=center scramble-page spnotice_chk][id*=0] img").attr("data-cfsrc").indexOf("blank.jpg") >=
                        0
                    ) {
                        add(
                            Page(
                                ...
                                element
                                    .select(
                                        "div[class=center scramble-page spnotice_chk][id*=0] img",
                                    ).attr("data-original")
                                    .split("\\?")[0],
                            ),
                        )
                        ...
                        add(
                            Page(
                                size,
                                "",
                                element.select("div[class=center scramble-page spnotice_chk][id*=0] img").attr("src").split("\\?")[0],
                            ),
                        )
                    }
                }
