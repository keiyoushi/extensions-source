...
class YagamiProject : ParsedHttpSource() {
    ...
    private class FormatList(
        formas: Array<String>,
    ) : Filter.Select<String>("Тип", formas)

    private data class FormUnit(
        val name: String,
        val query: String,
    )
