...
object DoujinioHelper {
    ...
    fun <T> deserialize(jsonString: String, dataSerializer: KSerializer<T>): PageResponse<T> {
        val pageResponseSerializer = PageResponse.serializer(dataSerializer)
        return json.decodeFromString(pageResponseSerializer, jsonString)
    }
