...
class MangaRawClub : ParsedHttpSource() {
    ...
    // Popular
    override fun popularMangaRequest(page: Int): Request = GET("$baseUrl/browse-comics/?results=$page&filter=views", headers)

    // Latest
    override fun latestUpdatesRequest(page: Int): Request = GET("$baseUrl/jumbo/manga/?results=$page", headers)
