...
class SortFilter : Filter.Select<String>("Sort", DISPLAY) {
...
class StatusFilter : Filter.Select<String>("Status", DISPLAY) {
    val value get() = VALUES[state]
    companion object {
...
class TypeFilter : Filter.Select<String>("Type", DISPLAY) {
    val value get() = VALUES[state]
    companion object {
...
class GenreFilter : Filter.Select<String>("Genre", DISPLAY) {
    val value get() = VALUES[state]
    companion object {
