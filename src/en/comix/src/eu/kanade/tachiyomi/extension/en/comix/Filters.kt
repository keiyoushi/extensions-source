...
class ContentRatingFilter(defaultValue: String) :
        Filter.Select<String>(
                "Content rating",
                DISPLAY_NAMES,
                API_VALUES.indexOf(defaultValue).takeIf { it >= 0 }
                        ?: API_VALUES.indexOf("suggestive"),
        ) {
...
class Filters(private val contentRatingDefault: String = "suggestive") {
    ...
    private open class UriMultiSelectOption(name: String, val value: String) :
