...
class ChapterCountFilter : UriPartFilter("Min chapters", CHAPTER_OPTIONS)

class GenderFilter : UriPartFilter("For", GENDER_OPTIONS)
...
internal val CHAPTER_OPTIONS = arrayOf(
    Pair(">= 0 Chapter", "0"),
...
internal val GENDER_OPTIONS = arrayOf(
    Pair("All", "-1"),
    Pair("Male", "0"),
    Pair("Female", "1"),
)
