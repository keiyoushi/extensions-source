...
class Atsumaru : HttpSource() {
    ...
    override fun popularMangaRequest(page: Int): Request = GET("$apiUrl/layouts/s1/sliders/hotUpdates", apiHeaders)
    ...
    override fun latestUpdatesRequest(page: Int): Request = GET("$apiUrl/layouts/s1/latest-updates", apiHeaders)
    ...
    override fun mangaDetailsRequest(manga: SManga): Request = GET(apiUrl + manga.url, apiHeaders)

    override fun mangaDetailsParse(response: Response): SManga = response.parseAs<MangaObjectDto>().manga.toSManga()
    ...
    override fun chapterListParse(response: Response): List<SChapter> {
        val chapterList =
            response.parseAs<MangaObjectDto>().manga.chapters!!.map {
                it.toSChapter(
    ...
    override fun pageListParse(response: Response): List<Page> {
        val chapter =
            response.parseAs<MangaObjectDto>().manga.chapters!!.first {
