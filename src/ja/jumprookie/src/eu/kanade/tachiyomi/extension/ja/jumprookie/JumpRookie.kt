...
class JumpRookie : HttpSource() {
    ...
    private var nextPopularPageKey: String? = null
    ...
    override fun popularMangaParse(response: Response): MangasPage {
        ...
        nextPopularPageKey = (baseUrl + nextUrlHeader).toHttpUrlOrNull()?.queryParameter("key")
        val document = response.asJsoup()
        val mangas = document.select("section.series-contents").map(::mangaFromElement)
        return MangasPage(mangas, nextPopularPageKey != null)
    }
