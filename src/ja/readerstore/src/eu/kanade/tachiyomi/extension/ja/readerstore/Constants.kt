...
const val HEADER_INDICES = "X-Indices"
const val HEADER_MAX_INDEX = "X-Max-Index"
const val HEADER_QUALITY = "X-Quality"
const val HEADER_EXCLUDE_RANGES = "X-Exclude-Ranges"
